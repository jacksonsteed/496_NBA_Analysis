...
games_from_2010 <- filter(filtered_games, (gameDate > '2010-07-01' & gameDate < '2011-06-30') & MIN > 0:01) #i think this last condition needs to change
...
model <- lm(PCT ~ player_score + MIN, data = train_data)
